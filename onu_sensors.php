...
echo "</b><br/>";
echo "<b>";
#echo "<a href=\"?page=onu&olt=$ip&mac=".$search_string.$mac."\" target=\"_blank\">";
echo "<a href=\"?page=onu&olt=$ip&mac=".$search_string.$mac."\">";
echo $mac;
echo "</a>";
echo "</b><br/>";
...
echo "<a href=\"?page=reboot_onu&olt=$ip&iface=$iface\"><img width=\"32\" src=\"images/reboot.png\"> Перезагрузка ONU</a>";
echo "<br/>";
echo "<a href=\"?page=save_conf&olt=$ip&iface=$iface\"><img width=\"32\" src=\"images/edit.png\"> Сохранить Конфиг</a>";
echo "</font>";
echo "</div>";
