...
var myPlacemark<?php echo $mark; ?> = new ym.Placemark(
                        ...
                        balloonContent: '<font size="3" color="#6B002B"><br/><b><?php echo $nameint; ?></b><br/><?php echo $comments; ?><br/><?php echo $pwr; ?><br/><?php echo $mac; ?><br/><a href="index.php?page=onu&olt=<?php echo $olt; ?>&iface=<?php echo $iface; ?>">Карта ONU</a></font>'
}, {
